...
# Вахта
# ---------------------------------------------------------------------- #
# Ходовые вахты, которые человек выбирает в настройках приложения.
# Ключи те же, что шлёт Mini App параметром watch.
WATCH_SCHEDULES = {
    "2nd": [(0, 4), (12, 16)],
    "3rd": [(8, 12), (20, 24)],
    "ch":  [(4, 8), (16, 20)],
    # Шесть через шесть -- обычное дело на малых судах и в каботаже
    "6a":  [(0, 6), (12, 18)],
    "6b":  [(6, 12), (18, 24)],
    # Дневной работник (механик-дневальный, боцман, стармех без вахты)
    "day": [(8, 17)],
}
